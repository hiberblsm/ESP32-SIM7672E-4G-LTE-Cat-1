/*
 * 03_TCPTest.h — ESP32-S3 + SIM7672E TCP Soket Testi
 *
 * Bu sınıf YALNIZCA 03_TCPTest için gereken fonksiyonları içerir:
 ...
 *
 * Diğer örneklerin (UDP/MQTT/SMS/DTMF) fonksiyonları BURADA YOKTUR.
...
public:
    ...
    TcpTest(uint8_t txPin      = SIM7672_TX_PIN,
