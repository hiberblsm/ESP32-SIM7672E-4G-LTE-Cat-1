/*
 * 09_SmsTemperature.h — ESP32-S3 + SIM7672E SMS Sıcaklık Ölçümü
 *
 * Bu sınıf YALNIZCA 09_SmsTemperature için gereken fonksiyonları içerir:
 ...
 *
 * Sıcaklık okuma (DS18B20) main.cpp'de tutulur.
 *
 ...
 *   GPIO 13      -> DS18B20 Data
 */

#ifndef SMSTEMPERATURE_H
#define SMSTEMPERATURE_H
...
class SmsTemperature {
public:
    // Kurucu: TX pini, RX pini, PWRKEY pini, RESET pini
    SmsTemperature(uint8_t txPin      = SIM7672_TX_PIN,
